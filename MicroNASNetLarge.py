...
for i in range(len(imgs_ordered)):
    patches = image.extract_patches_2d(imgs_ordered[i], (331,331), max_patches = 100)
...
model.fit(X_train, y_train, epochs = 5, batch_size = 16, validation_data=(X_test, y_test), callbacks=[time_callback])
